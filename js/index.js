...
function tweededeel () {
    //setTimeout(function(){document.getElementById("tilemapimg").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("tilemapimg2").style.opacity = 1}, 6* sec);
    //setTimeout(function(){document.getElementById("door1").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("oldhouse").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("wisetree").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("pond").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("water1").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("water2").style.display = "none"}, 6* sec);
    //setTimeout(function(){document.getElementById("water3").style.display = "none"}, 6* sec);
}
